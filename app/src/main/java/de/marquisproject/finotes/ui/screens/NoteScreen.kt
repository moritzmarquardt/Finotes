        ...
        with(sharedTransitionScope){
            Column(
                modifier = Modifier
                    ...
                    .sharedBounds(
                        sharedTransitionScope.rememberSharedContentState(key = "note-${currentNote.id}"),
                ...
                BasicTextField(
                    ...
                    modifier = Modifier
                        ...
                        .padding(bottom = 8.dp)
                        .sharedElement(
                            sharedTransitionScope.rememberSharedContentState(key = "title-${currentNote.id}"),
                            animatedVisibilityScope = animatedContentScope
                        ),
                ...
                BasicTextField(
                    ...
                    modifier = Modifier
                        ...
                        .sharedElement(
                            sharedTransitionScope.rememberSharedContentState(key = "body-${currentNote.id}"),
                            animatedVisibilityScope = animatedContentScope
                        ),
                    decorationBox = { innerTextField ->
                        Box(
